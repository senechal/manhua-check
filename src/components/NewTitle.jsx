...
export const NewTitle = ({ onSubmit, size }) => {
  ...
  return (
    ...
    <button
      ...
      className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-14 px-4 bg-[#e1e243] hover:bg-[#a5a51a] text-[#0f1a24] gap-2 pl-4 text-sm font-bold leading-normal tracking-[0.015em]"
    >
      {
        loading
